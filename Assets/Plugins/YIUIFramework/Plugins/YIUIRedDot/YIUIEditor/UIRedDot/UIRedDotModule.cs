...
namespace YIUIFramework.Editor
{
    internal class UIRedDotModule : BaseYIUIToolModule
    {
        ...
        private const string UIRedDotAssetFolderPath = "Assets/Resources/RedDot";

        [LabelText("红点枚举资源路径")]
        [FolderPath]
        [ShowInInspector]
        [ReadOnly]
        public const string UIRedDotKeyAssetPath = "Assets/Resources/RedDot/RedDotKeyAsset.asset";
        ...
        [ShowInInspector]
        [ReadOnly]
        public const string UIRedDotConfigAssetPath = "Assets/Resources/RedDot/RedDotConfigAsset.asset";
